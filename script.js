...
const CountDown = ({ fx, onComplete }) => {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    React.createElement(
      "h2",
      { ref: three, className: "countdown-number", style: { display: "none" } },
      "3"
    ) /*#__PURE__*/,

    React.createElement(
      "h2",
      { ref: two, className: "countdown-number", style: { display: "none" } },
      "2"
    ) /*#__PURE__*/,

    React.createElement(
      "h2",
      { ref: one, className: "countdown-number", style: { display: "none" } },
      "1"
    )
  );
};
...
const FinishScreen = ({ newHigh, onRestart, onReset, result } /*#__PURE__*/) =>
  React.createElement(
    "div",
    { className: "info-screen" } /*#__PURE__*/,
    React.createElement(
      "div",
      { className: "results" },
      newHigh /*#__PURE__*/ &&
      ...
      !newHigh /*#__PURE__*/ &&
        React.createElement(
          "h2",
          { className: "info__text boring-text" },
          `You Scored ${result}`
        )
    ) /*#__PURE__*/,
...
const StartScreen = ({ onStart } /*#__PURE__*/) =>
  React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("span", null, "Mole")
    ) /*#__PURE__*/,
...
const Mole = ({
  ...
  return /*#__PURE__*/ React.createElement(
    "div",
    { className: "mole__hole", ref: moleContainerRef } /*#__PURE__*/,
    React.createElement(
      "svg",
      {
        className: "mole",
      ...
      React.createElement(
        ...
        React.createElement(
          "radialGradient",
          {
            ...
            gradientTransform:
              "translate(101 137) rotate(90) scale(115 90.9302)",
          } /*#__PURE__*/,
          ...
          React.createElement("stop", {
            offset: "1",
            stopColor: "hsla(var(--hue, 0), 10%, 10%, 0.35)",
          })
        )
      ) /*#__PURE__*/,
      ...
      React.createElement(
        "g",
        { className: "mole__ground" } /*#__PURE__*/,
        React.createElement(
          "clipPath",
          {
            id: "hole-mask",
          ...
          React.createElement("ellipse", { cx: 100, cy: 175, rx: 100, ry: 25 })
        ) /*#__PURE__*/,

        React.createElement(
          "g",
          { clipPath: "url(#hole-mask)" } /*#__PURE__*/,
      ...
      React.createElement(
        "g",
        { clipPath: "url(#mole-clip)" } /*#__PURE__*/,
        React.createElement(
          "g",
          { className: "mole__mole", ref: moleRef } /*#__PURE__*/,
          React.createElement("path", {
          ...
          React.createElement(
            "g",
            { className: "mole__eyes", ref: eyesRef } /*#__PURE__*/,
          ...
          React.createElement(
            "g",
            { className: "mole__eyes--crossed" } /*#__PURE__*/,
            React.createElement("path", {
          ...
          React.createElement(
            "g",
            { ref: faceRef } /*#__PURE__*/,
            React.createElement(
              "g",
              { clipPath: "url(#muzzle-clip)" } /*#__PURE__*/,
              React.createElement("ellipse", {
          ...
          React.createElement(
            "g",
            { className: "specs", ref: specsRef } /*#__PURE__*/,
            React.createElement("circle", {
              cx: "53",
              cy: "84",
              r: "12",
            ...
            React.createElement(
              ...
              React.createElement("circle", { cx: "53", cy: "84", r: "10" })
            ) /*#__PURE__*/,
            ...
            React.createElement(
              "g",
              {
                ...
                className: "specs__glare",
              } /*#__PURE__*/,
              React.createElement("path", {
                d: "m57.006 56 4.23 2.1-24.006 48.37-4.23-2.1zm5 3 2.154 1.07-24.006 48.37L38 107.37z",
              })
            )
          ) /*#__PURE__*/,
          ...
          React.createElement(
            "g",
            { className: "mole__cap", ref: capRef } /*#__PURE__*/,
            React.createElement("path", {
              ref: capPeak,
            ...
            React.createElement(
              ...
              React.createElement("path", {
                d: "M99.5 8C71 8 29 25.5 22 64.5h157C173.5 21.5 128 8 99.5 8z",
              })
            ) /*#__PURE__*/,

            React.createElement(
              "g",
              { clipPath: "url(#cap-clip)" } /*#__PURE__*/,
              React.createElement("path", {
                ref: capBody,
      ...
      React.createElement(
        ...
        React.createElement(
          "foreignObject",
          { x: 0, y: 0, width: 200, height: 200 } /*#__PURE__*/,
          React.createElement(
            "button",
            { ref: buttonRef, onClick: whack, className: "mole__whack" },
            "Whack!"
          )
        )
      )
...
const Score = ({ value } /*#__PURE__*/) =>
  React.createElement(
    ...
    React.createElement("span", { className: "info__text" }, value)
  );
...
const Mallet = () => {
  ...
  return /*#__PURE__*/ React.createElement(
    "div",
    { ref: cursorRef, className: "mallet" } /*#__PURE__*/,
...
const Game = () => {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    !starting &&
      !playing &&
      !finished &&
      /*#__PURE__*/ React.createElement(HiScore, { value: highScore }),

    !starting &&
      !playing &&
      !finished /*#__PURE__*/ &&
      React.createElement(StartScreen, { onStart: startGame }),
    ...
    playing /*#__PURE__*/ &&
      React.createElement(
        ...
        React.createElement(Mallet, null) /*#__PURE__*/,
        React.createElement(
          "div",
          { className: "game-info" } /*#__PURE__*/,
          React.createElement(Score, { value: score }) /*#__PURE__*/,
    ...
    React.createElement(
      "main",
      { ref: boardRef } /*#__PURE__*/,
      React.createElement(
        "div",
        { className: "moles" },
        moles.map(({ speed, delay, points }, id /*#__PURE__*/) =>
    ...
    finished /*#__PURE__*/ &&
      React.createElement(FinishScreen, {
        onRestart: startGame,
        onReset: resetGame,
